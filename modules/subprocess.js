...
const nsIEnvironment = Components.classes["@mozilla.org/process/environment;1"].getService(Components.interfaces.nsIEnvironment);
const DISPLAY = nsIEnvironment.get("DISPLAY");

const DEFAULT_ENVIRONMENT = [];
if (Cc["@mozilla.org/xre/app-info;1"].getService(Ci.nsIXULRuntime).OS == "Linux" && DISPLAY) {
  DEFAULT_ENVIRONMENT.push("DISPLAY=" + DISPLAY);
}
